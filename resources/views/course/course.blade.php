...
<html lang="en">
  ...
  <body>
    ...
    <section id="header" class="bg-white pt-5 mb-5">
        <div class="container">
            <div id="headerHeadline" class="p-3" data-aos="fade-right" data-aos-duration="3000">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" id="modal-size">
    <div class="modal-content">
      <div class="modal-body rounded" style="background-color: #f1f1f1" id="model-edit">
        <section id="checkout">
            <div class="container"> 
                <div class="row justify-content-center p-3">
                    ...
                    <div id="produk-checkout" class="bg-white rounded p-3 pb-4">
                        ...
                        <a href="#" class="btn btn-secondary fw-medium p-2"  onclick="prosses()">Checkout</a>
                        </div>
                        </div>
