            ...
            <div class="container">
                <div class="row">
                    <div class="col-6 d-flex align-items-center" >
                        <div class="d-block" id="textHeader" data-aos="fade-right" data-aos-duration="3000">
                    ...
                    <div class="col-6" id="imgHeader" data-aos="fade-left" data-aos-duration="3000">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-5 mb-3">
          <div class="card shadow" data-aos="zoom-in-up" data-aos-duration="1000">
                  ...
                  <div class="card-body">
                      ...
                      <div class="d-flex align-items-center justify-content-between p-1 mt-1" id="btn-transaksi-course">
                            <a href="#" class="text-primary fw-bold harga-teks">Rp 1.300.000,-</a>
                            <a href="/course" class="btn btn-secondary fw-medium">Beli Kelas</a>
                      </div>
                  </div>
            </div>
        ...
        <div class="col-lg-5 mb-3">
          <div class="card shadow" data-aos="zoom-in-up" data-aos-duration="1000">
                  ...
                  <div class="card-body">
                      ...
                      <div class="d-flex align-items-center justify-content-between p-1 mt-1" id="btn-transaksi-course">
                            <a href="#" class="text-primary fw-bold harga-teks">Rp 900.000,-</a>
                            <a href="/course" class="btn btn-secondary fw-medium">Beli Kelas</a>
                      </div>
                  </div>
            </div>
