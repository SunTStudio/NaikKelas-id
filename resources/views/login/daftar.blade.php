        ...
        <div class="row justify-content-center p-4">
          <div class="col-lg-4 bg-white p-4 rounded shadow text-center" data-aos="fade-up" data-aos-duration="3000">
            ...
            <form class="mt-3 text-center" action="/" data-aos="zoom-in-down" data-aos-duration="3000">
              ...
              <button type="submit" class="btn btn-secondary p-1 ps-4 pe-4 fw-medium">Daftar Sekarang</button>
            </form>
            <p class="text-center fw-normal mt-4 text-secondary" >Sudah Punya Akun? <a href="/login">Masuk disini</a> </p>
          </div>
        </div>
      </div>
    </section>
